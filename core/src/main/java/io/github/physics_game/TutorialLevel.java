...
public class TutorialLevel extends  Level {
    ...
    public TutorialLevel() {
        ...
        this.ball = new DynamicObject(0, 0.5f, 0.99f, 1f, circleVertices, 6f, 4f, 0f);
        addPhysicsObject(ball);

        DynamicObject cup = new DynamicObject(1, 0.5f, 0.99f, 1f, cupVertices, 5f, 2f, 0f);
        addPhysicsObject(cup);

        this.cupInside = new FollowingTriggerObject(2, 0.5f, 0.99f, cupInsideVertices, 5f, 2f, 0f, cup);
